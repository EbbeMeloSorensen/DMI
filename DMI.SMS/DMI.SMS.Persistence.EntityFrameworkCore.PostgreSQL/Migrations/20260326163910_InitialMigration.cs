        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaroLevel = table.Column<double>(type: "double precision", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: true),
                    Sl_utm = table.Column<int>(type: "integer", nullable: true),
                    Sl_northing = table.Column<double>(type: "double precision", nullable: true),
                    Sl_easting = table.Column<double>(type: "double precision", nullable: true),
                    Sl_geo_lat = table.Column<double>(type: "double precision", nullable: true),
                    Sl_geo_long = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    GdbFromDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    GdbToDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    si_northing = table.Column<double>(type: "double precision", nullable: true),
                    si_easting = table.Column<double>(type: "double precision", nullable: true),
                    si_geo_lat = table.Column<double>(type: "double precision", nullable: true),
                    si_geo_long = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    addworkforcedate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    hha = table.Column<double>(type: "double precision", nullable: true),
                    hhp = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    wgs_lat = table.Column<double>(type: "double precision", nullable: true),
                    wgs_long = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    gdb_from_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    gdb_to_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
